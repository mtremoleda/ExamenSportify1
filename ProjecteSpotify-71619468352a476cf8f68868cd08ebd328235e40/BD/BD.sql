...
CREATE TABLE Perfils (
	 ...
	 Estat NVARCHAR(15) NOT NULL
);

CREATE TABLE Imatges (
	Id UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
	Titul NVARCHAR(50) NOT NULL,
	Descripcio NVARCHAR(255) NOT NULL,
	PerfilId UNIQUEIDENTIFIER NOT NULL FOREIGN KEY REFERENCES Perfils(Id),
);
